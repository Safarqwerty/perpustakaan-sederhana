            ...
            <div
                ...
                <div style="padding: 1.5rem; background-color: #1A202C; border-bottom: 1px solid #E2E8F0;">
                    <div
                        ...
                        @if (auth()->user()->role !== 'admin')
                            <a href="{{ route('pengembalian-buku.create') }}"
                                ...
                                @forelse ($pengembalian as $item)
                                    <tr style="background-color: #2D3748;">
                                        <td style="padding: 0.75rem; color: #E2E8F0;">
                                            {{ $item->peminjaman->no_peminjaman }}</td>
                                        <td style="padding: 0.75rem; color: #E2E8F0;">
                                        ...
                                        <td style="padding: 0.75rem; color: #E2E8F0;">
                                            @if (auth()->user()->role !== 'siswa')
                                                ...
                                                <button
                                                    onclick="if(confirm('Apakah Anda yakin ingin menghapus pengembalian ini?')) document.getElementById('deleteForm-{{ $item->id }}').submit();"
